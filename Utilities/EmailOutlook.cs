...
namespace ScheduleNoti.Utilities
{
    class EmailOutlook
    {
        ...
        public static bool sendEmailViaOutlook( string sToAddress, string sCc, string sSubject, string sBody, BodyType bodyType, List<string> arrAttachments = null, string sBcc = null)
        {
            ...
            //      = true if success
            bool bRes = false;
            string sFromAddress = UserPrincipal.Current.EmailAddress;
            try
            {
            ...
            {
                throw new Exception("ERROR: Failed to send mail: " + ex.Message);
            }
